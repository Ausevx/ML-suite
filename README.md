...
- **NOTE:** For Apple silicon, GPU acceleration might not provide faster computation because of multithreading compatibility issues with MPS(Metal Performance Shaders) and neural networks (PyTorch), which may need to be limited to a single thread.
