...
# Thread-safe download status tracking with RLock for recursive locking capability
...
def download_model_background(model_name):
    """Download model in background thread (thread-safe)"""
    ...
    try:
        ...
        # Download the model (outside lock to avoid blocking)
        with _download_status_lock:
...
def start_model_download():
    """Start downloading a model (thread-safe)"""
